...
#
# Commands:
#   успех - Получить апплодисменты
#   абсолютный успех - Получить саркастические апплодисменты
#
# Author:
#   joshfrench
...
module.exports = (robot) ->
  robot.hear /успех/i, (msg) ->
    type = if (/абсолютный/i).test(msg.message.text) then images.insincere else images.sincere
